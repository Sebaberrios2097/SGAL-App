...
using SieteVidasAPI.Entities.SieteVidas;

namespace SieteVidasAPI.Context;
...
public partial class SieteVidasContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<InvConfiguracionCortesia>(entity =>
        {
            entity.Property(e => e.IdConfiguracion).ValueGeneratedNever();
        });
        ...
        {
            entity.HasOne(d => d.IdMateriaPrimaNavigation).WithMany(p => p.InvPresentacionesMateriaPrima).HasConstraintName("FK_Inv_Presentaciones_Materia_Prima_Inv_Materia_Prima");
        ...
        modelBuilder.Entity<InvProductosCortesia>(entity =>
        {
            ...
            entity.HasOne(d => d.IdProductoNavigation).WithOne(p => p.InvProductosCortesia)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasOne(d => d.IdMateriaPrimaNavigation).WithMany(p => p.TurProductosBitacoraMateriales)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Tur_Productos_Bitacora_Materiales_Inv_Materia_Prima");

            entity.HasOne(d => d.IdProductosBitacoraNavigation).WithMany(p => p.TurProductosBitacoraMateriales)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasOne(d => d.IdIngredienteExtraNavigation).WithMany(p => p.VenDetalleVenta).HasConstraintName("FK_Ven_Detalle_Venta_Inv_Ingredientes_Extra");
        ...
        {
            entity.HasOne(d => d.IdDetalleVentaNavigation).WithMany(p => p.VenDetalleVentaMateriales).HasConstraintName("FK_Ven_Detalle_Venta_Materiales_Ven_Detalle_Venta");
