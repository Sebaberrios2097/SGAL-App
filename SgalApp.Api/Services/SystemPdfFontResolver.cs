...
{
    private const string Regular = "sgal-regular";
    private const string Bold = "sgal-bold";
    private const string Italic = "sgal-italic";
    private const string BoldItalic = "sgal-bold-italic";
